...
public final class In {
     ...
     *
     * @return {@code true} if this input stream exists; {false} otherwise
     */
    ...
    /**
     * Returns true if this input stream has more input.
     * Use this method to know whether the next call to will succeed.
     *
     * @return {@code true} if this input stream has more input;
     *         {@code false} otherwise
     */
    ...
    /**
      * Reads the next token from this input stream and returns
      * it as a {String}.
      *
    ...
    public String readString() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'String'"
                                             + "value from the input stream, "
                                             + "but no more "
    ...
    public int readInt() {
        try {
            ...
            throw new InputMismatchException("attempts to read an 'int' "
                                             + "value from the input stream, "
                                             + "but the next token is \""
                                             + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read an 'int' "
                                             + "value from the input stream, "
                                             + "but no more "
                                             + "tokens are available");
        }
    ...
    public double readDouble() {
        try {
            ...
            throw new NoSuchElementException("attemps to read a 'double' "
                                             + "value from the input stream, "
                                             + "but no more "
                                             + "tokens are available");
        }
    ...
    public float readFloat() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'float' "
                                             + "value from the input stream, "
                                             + "but the next token is \""
                                             + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'float' "
                                             + "value from the input stream, "
                                             + "but no more "
                                             + "tokens are available");
        }
    ...
    public long readLong() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'long' "
                                             + "value from the input stream, "
                                             + "but the next token is \""
                                             + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'long' "
                                             + "value from the input stream, "
                                             + "but no more "
                                             + "tokens are available");
        }
    ...
    public short readShort() {
        try {
            ...
            String token = scanner.next();
            throw new InputMismatchException("attempts to read a 'short' "
                                             + "value from the input stream, "
                                             + "but the next token is \""
                                             + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attemps to read a 'short' "
                                             + "value from the input stream, "
                                             + "but no more "
                                             + "tokens are available");
        }
